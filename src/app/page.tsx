    ...
    <main className="min-h-screen bg-[#fbf7ee] text-[#2a2319] selection:bg-[#2a2319] selection:text-[#fbf7ee]">
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-[#f4ead8]/10 bg-[#060504]/82 px-5 py-4 backdrop-blur-md sm:px-8">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          ...
          <nav aria-label="Primary navigation" className="hidden items-center gap-6 font-mono text-xs uppercase tracking-[0.22em] text-[#d6b47f] md:flex">
            ...
            <Link href="/photos" className="hover:text-[#f4ead8]">photos</Link>
      ...
      <footer className="border-t border-[#e0d2b9] px-5 py-8 text-sm text-[#5f4a32] sm:px-8">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/events" className="hover:text-[#2a2319]">events</Link>
            <Link href="/photos" className="hover:text-[#2a2319]">photos</Link>
            <Link href="/media-package" className="hover:text-[#2a2319]">press kit</Link>
