...
const UpcomingGigs: React.FC<UpcomingGigsProps> = ({ gigs }) => {
  ...
  return (
    <section id="upcoming" className="relative z-10 mx-auto w-full max-w-6xl scroll-mt-6 px-5 py-6 sm:px-6 lg:px-8">
      <div className="rounded-xl border border-stone-700/70 bg-[#17110d] p-6 shadow-lg shadow-black/15 sm:p-8">
        <div className="mb-6">
        ...
        {upcomingGigs.length > 0 ? (
          ...
          <div className="rounded-xl border border-stone-700/70 bg-[#120d09] p-6 text-stone-200">
