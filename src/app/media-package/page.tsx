...
const mediaFiles = {
  images: [
    ...
    { name: 'EDFH Yellow Room', format: 'JPG', size: '532 KB', downloadUrl: '/images/gallery/edfh-yellow-room.jpg', description: 'Facilitating inside Ecstatic Dance Festival Holland' },
